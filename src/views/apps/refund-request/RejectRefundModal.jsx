  ...
  return (
    <Dialog open={isOpen} onClose={handleRejectRefundTicket}>
      <DialogTitle sx={{ m: 0, p: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        Reject Refund
        <IconButton aria-label='close' onClick={handleRejectRefundTicket} size='small'>
      ...
      <div className='mt-3'>
        <DialogActions>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <Button variant='contained' color='primary' size='small' type='submit' disabled={isLoading}>
