...
import { Card, CardContent, CircularProgress, TextField, Typography, Box, TablePagination } from '@mui/material'

import tableStyles from '@core/styles/table.module.css'

import { useMyRefundRequestQuery } from '@/redux-store/services/api'

const formatAmountWithCommas = amount => (typeof amount === 'number' ? amount.toLocaleString() : '0')
...
const MyRefundrequestRow = ({ myRefundData }) => {
  ...
  return (
    <tr>
      <td className='p-3 border-b text-primary underline'>{booking?.booking_id}</td>
