...
const FlightFound = () => {
    ...
    const toggleFilterVisible = (index) =>
        setFilterVisible(filterVisible == index ? null : index);
    ...
    const handleStopChange = (stopLabel) => {
        let stopNumber =
            stopLabel === "Non Stop" ? 0 : stopLabel === "1 Stop" ? 1 : 2;

        setSelectedStops((prev) =>
            prev.includes(stopNumber)
                ? prev.filter((s) => s !== stopNumber)
                : [...prev, stopNumber]
        );
                                ...
                                <div className="lg:flex justify-between items-center">
                                    <div>
                                        ...
                                        <span className="text-gray-500 text-sm">
                                            {queryParams?.route_type} • {travelerCount} Travelers •{" "}
                                            {queryParams?.cabin_class}
                                        </span>
                                    </div>
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <div className="text-center">
                                                        ...
                                                        <span className="text-gray-500 text-xs">
                                                            {dayjs(
                                                                data?.legs[0]?.segments[0]?.departure_datetime
                                                            ).format("hh:mm A")}
                                                        </span>
                                                    </div>
                                                    <div className="text-center">
                                                            ...
                                                            <div className="grid grid-cols-12 items-center gap-2 border-t py-2">
                                                                ...
                                                                <div className="col-span-12  lg:col-span-6 xl:col-span-5">
                                                                    {data?.name == "SABRE_API" ? (
                                                                        ...
                                                                        <div className="flex gap-2 justify-start items-center">
                                                                            {faresGroupData?.bagage_info
                                                                                ?.maxAllowedWeight?.weight === 0 ? (
                                                                                <img
                                                                                    src="/media/icons/no-baggage-icon.svg"
                                                                                    className="h-5"
                                                                                    alt=""
                                                                                />
                                                                            ) : (
