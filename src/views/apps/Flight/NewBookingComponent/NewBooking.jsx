                        ...
                        <div className='grid grid-cols-12 gap-5'>
                          ...
                          <div className='col-span-6 mb-5'>
                            <MuiDropdown
                                                        ...
                                                        options={[{ label: "CNIC", value: "I" }, { label: "PASSPORT", value: "P" }].map((document) => ({
  ...
  <Card className="bg-base-100 mb-5">
    <CardContent>
      ...
      {bookingAvailabilityConfirmationData?.fare_info[0]?.price?.fare_break_down &&
        Object.entries(bookingAvailabilityConfirmationData?.fare_info[0]?.price?.fare_break_down).length > 0 && (
          <div>
            {Object.entries(bookingAvailabilityConfirmationData?.fare_info[0]?.price?.fare_break_down).map(
              ([key, data], index) => {
                const passengerType =
                ...
                return (
                  <div key={index} className="flex justify-between border-b pb-2">
                    <p className="font-semibold">
                      {bookingAvailabilityConfirmationData?.airline?.iata_code} ({passengerType}) x {data?.quantity}:
                    </p>
