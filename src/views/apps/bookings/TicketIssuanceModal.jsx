...
const TicketIssuanceModal = ({
    ...
    const [ticketOptEmail, { isLoading: ticketOtpLoading }] =
                    ...
                    <CardContent className="gap-0">
                        ...
                        {step === 2 && (
                            <div className="flex justify-center flex-col items-center w-full mt-5">
                                ...
                                <BookingOTP bookingId={bookingPnr} refectBooking={refectBooking} handleIssueTicketModal={handleIssueTicketModal} />
                            </div>
                        )}
                    </CardContent>
                </Card>
                        ...
                        (selectedAgency || selectedEmployee) && (
                            <div className="flex justify-end w-full">
                                <Button
                                    ...
                                    // }}
                                    onClick={handleSelfProceed}
                                    loading={ticketOtpLoading} disabled={ticketOtpLoading}
                                >
                                    Proceed
                                </Button>
                            </div>
