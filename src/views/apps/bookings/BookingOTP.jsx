...
const BookingOTP = ({ bookingId, refectBooking, handleIssueTicketModal }) => {
    ...
    const [issueTicket, { isLoading: isIssueTicketLoading }] =
    ...
    return (
        <>
            ...
            <div className="mt-4 md:mt-6">
                <Button variant="contained" onClick={verifyOTPIssueTicket} loading={isIssueTicketLoading} disabled={isIssueTicketLoading}>Verify OTP & Issue Ticket</Button>
            </div>
        </>
    );
};
