...
// MUI Imports
import { Button, Card, CardContent, IconButton, TablePagination, TextField, Tooltip } from '@mui/material'
  ...
  return (
    <>
      ...
      {showGroupTypeDeleteModal && (
        <GroupTypeDeleteModal
          open={showGroupTypeDeleteModal}
          onClose={() => {
            setShowGroupTypeDeleteModal(false)
            setGroupTypeData({})
          }}
          refetch={refetch}
          groupTypeData={groupTypeData}
