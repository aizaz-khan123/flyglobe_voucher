...
const AgencyDeposit = () => {
  ...
  const { data: detail_data, isFetching, refetch: RefundRequestRefetch } = useDepositsOrgListQuery({ searchText, pageUrl });
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        accessorKey: 'reciept',
        cell: ({ row }) => (
          <img src={row.original.reciept} alt="Receipt" width={50} height={50} />
        ),
      },
      {
        header: 'Action',
