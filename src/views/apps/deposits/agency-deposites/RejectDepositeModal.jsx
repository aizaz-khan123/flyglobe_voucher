'use client'
import { useDepositsAcceptMutation, useDepositsRejectMutation } from '@/redux-store/services/api';
        ...
        <Dialog open={isOpen} backdrop>
            <DialogTitle className="font-semibold flex justify-between">
                ...
                <Button
                    ...
                    onClick={handleRejectDepositeModal}
                >
                    <IoMdClose/>
                </Button>
            </DialogTitle>
            <DialogContent>
                <p>
                    You are about to reject the deposite request. Would you like to proceed further?
                </p>
