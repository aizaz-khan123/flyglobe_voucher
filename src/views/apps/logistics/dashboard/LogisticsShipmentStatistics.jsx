...
const series = [
  ...
  },
  {
    name: 'Umrah Bookings',
    type: 'line',
    data: [4, 18, 33, 42, 55, 1, 5, 6, 36, 24]
  },
  {
    name: 'Hotel Bookings',
    type: 'column',
    data: [21, 2, 89, 7, 81, 34, 41, 17, 24, 17]
  },
  {
...
const LogisticsShipmentStatistics = () => {
  ...
  return (
    <Card>
      <CardHeader title='Sales and Booking Statistics' subheader='Total number of bookings 500' action={<MonthButton />} />
      <CardContent>
        <AppReactApexCharts
