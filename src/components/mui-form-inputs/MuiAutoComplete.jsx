        ...
        return (
          <Autocomplete
            ...
            isOptionEqualToValue={(option, val) =>
              selectLabelInsteadOfValue ? option.label === (val?.label || val) : option.value === (val?.value || val)
            }
            value={
            ...
            renderInput={params => (
              <TextField
                ...
                InputProps={{
                  ...
                  startAdornment: (
                    <>
                      {!selectedValue && selectIcon && <InputAdornment position='start'>{selectIcon}</InputAdornment>}
